...
def buscar_informacoes(valor_busca: str) -> dict:
    ...
    Realiza a busca:
      ...
      - Caso contrário, aplica a normalização dos termos e tenta:
          ...
          2. Se não houver resultados, seleciona linhas que contenham o primeiro termo e retorna
             aquelas com o maior número de coincidências nos demais termos.
    """
    ...
    # Busca completa com todos os termos
